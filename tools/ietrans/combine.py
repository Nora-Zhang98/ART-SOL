...
model_name = 'motifs'# sys.argv[1]
extra_path = '/root/autodl-nas/IETrans/tools/ietrans/ex_em_E.pk'
intra_path = '/root/autodl-nas/IETrans/tools/ietrans/in_em_E.pk_topk_0.7'
...
img_info_path = "/root/autodl-nas/IETrans/datasets/vg/image_data.json"
...
freq_rels = [0, 31, 20, 22, 30, 48, 29, 50, 1, 21, 8, 43, 40, 49, 41, 23] # 15个+bg
# bg, on has in of wearing near with above holding behind under sitting_on wears standing_on in_front_of
