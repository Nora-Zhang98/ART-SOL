...
print(ratio)
score = json.load(open("/root/autodl-nas/IETrans/tools/output/relation_baseline/ex_score.json", "r"))
em = pickle.load(open("/root/autodl-nas/IETrans/tools/output/relation_baseline/ex_raw_em_E.pk", "rb"))
