...
class VCTreeLSTMContext(nn.Module):
    ...
    def forward(self, x, proposals, rel_pair_idxs, global_features, logger=None, all_average=False, ctx_average=False, use_gt=False, rel_labels=None):
        ...
        # ---------------Pair-level Context Extraction-------------
        union_feature = self.interaction_head(x, obj_ctxs, proposals, global_features, rel_pair_idxs, use_gt, rel_labels)
        ...
        return obj_dists, obj_preds, edge_ctx, bi_preds, union_feature
