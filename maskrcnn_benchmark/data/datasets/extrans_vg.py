...
class ExTransDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, split, img_dir, roidb_file, dict_file, image_file, transforms=None,
        ...
        self.filter_non_overlap = filter_non_overlap and self.split == 'train' # false
        ...
        if self.custom_eval:
            ...
            # data = pickle.load(open(specified_data_file, "rb"))  # 66983
        ...
        for a, b in zip(self.data, self.filenames):
            assert a['img_path'].split('/')[-1] == b.split('/')[-1]


    def __getitem__(self, index):
        # path = '/home/stormai/userfile/zrn/' + self.data[index]["img_path"]
