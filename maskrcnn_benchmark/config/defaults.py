...
_C.MODEL.PRETRAINED_DETECTOR_CKPT = "/home/stormai/userfile/zrn/pretrained_ckpt/model_final.pth"
...
_C.DATALOADER.NUM_WORKERS = 1 #改 4
...
_C.WSUPERVISE.SPECIFIED_DATA_FILE = "/home/stormai/userfile/zrn/IETrans/tools/ietrans/vctree_em_E.pk"
...
# IETrans
_C.IETRANS = CN()
_C.IETRANS.RWT = True # use reweight or not

# UPT
_C.UPT = CN()
_C.UPT.HIDDEN_DIM = 256
_C.UPT.REPR_DIM = 512
_C.UPT.NUM_CHANNELS = 2048